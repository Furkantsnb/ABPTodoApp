...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e8389d23-b1ab-4577-8fac-6a7b8f5a40a4
```

> `e8389d23-b1ab-4577-8fac-6a7b8f5a40a4` is the password of the certificate, you can change it to any password you want.
